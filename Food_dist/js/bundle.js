...
function calc() {
    ...
    function calcTotal() {
        if (!sex || !height || !weight || !age || !ratio) {
            result.textContent = "___________ккал";
            return;
        }
        if (sex === 'female') {
...
function indicators() {
    ...
    next.addEventListener('click', () => {
        ...
        slidesField.style.transform = `translateX(-${offset}px)`; //на сколько сдвигаемся влево
...
function slider() {
    ...
    const slides = document.querySelectorAll('.offer__slide'),
        slider = document.querySelector('.offer__slider'), //indicators
...
window.addEventListener('DOMContentLoaded', function () {
    const tabs = __webpack_require__(/*! ./modules/tabs */ "./js/modules/tabs.js"),
        ...
        indicators = __webpack_require__(/*! ./modules/indicators */ "./js/modules/indicators.js"),
