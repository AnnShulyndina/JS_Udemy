...
function forms(formsSelector, modalTimerId) {
    ...
    function bindPostData(form) {
        form.addEventListener('submit', (e) => {
            ...
            Object(function webpackMissingModule() { var e = new Error("Cannot find module '../services/services'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())('http://localhost:3000/requests', json)
                .then(data => {
                    console.log(data);
